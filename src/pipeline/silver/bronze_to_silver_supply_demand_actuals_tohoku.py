"""Transform Tohoku supply_demand_actuals from bronze into silver.
...
def run_bronze_to_silver_supply_demand_actuals_tohoku(
    *,
    ...
    """Run the bronze-to-silver transform for Tohoku's supply_demand_actuals."""
